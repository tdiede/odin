(ns member.profile.contact.views
...
(defn- contact-info-ui []
  (fn []
    (let [form        (ant/get-form)
          ...
          is-saving   (subscribe [:ui/loading? :profile.contact.personal/submitting])]
      [:div
       (contact-info-form)
...
(defn- emergency-contact-ui []
  (fn []
    (let [form        (ant/get-form)
          ...
          is-saving   (subscribe [:ui/loading? :profile.contact.emergency/submitting])]
      [:div
