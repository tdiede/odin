(ns member.profile.views
  (:require [antizer.reagent :as ant]
            [cljs.core.match :refer-macros [match]]
            [iface.components.menu :as menu]
            [member.content :as content]
            [member.l10n :as l10n]
            [member.profile.membership.views :as membership]
            [member.profile.payments.history.views :as phistory]
            [member.profile.payments.sources.views :as psources]
            [member.profile.contact.views :as contact]
            [member.profile.settings.views :as settings]
